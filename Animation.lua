...
-- Original code 'DP Emotes' by andristum for fivem : https://github.com/andristum/dpemotes
...
DP.PropEmotes = {
    ["umbrella"] = { "amb@world_human_drinking@coffee@male@base", "base", "Umbrella", AnimationOptions = {
        Prop = {"p_amb_brolly_01", "p_amb_brolly_01_s"},
        PropBone = 57005,
...
local function addProps(model, bone, off1, off2, off3, rot1, rot2, rot3, localSave)
    ...
    model = util.joaat(model[math.random(1, #model)])
    ...
    if localSave == PlayerProps then PlayerHasProp = true end
end
local function clearProps(prop)
    ...
    if prop == PlayerProps then PlayerHasProp = false end
    prop = {}
end
